...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if($permis == 1){
        ...
        if(empty($errors)){
            ...
            if(mysql_query($q1))
            	header("location: index.php?mod=member&act=edit&rp=1&u_id=$c_id");
			else
				header('location: index.php?mod=member&act=edit&rp=2&u_id=$c_id');
        }else{
            header('location: index.php?mod=member&act=edit&rp=3&u_id=$c_id');
        }
    ...
    header('location: index.php?mod=member&act=edit&u_id=$c_id');
}
?>