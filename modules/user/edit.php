...
<div class="container_12">
    ...
    <div class="bottom-spacing">
            ...
            <div class="float-right" >
                <a href="?mod=user&act=reset_pass&u_id=<?php echo $ro['id'];?>" class="button">
                    <span>Khôi phục mật khẩu <img src="images/notification-exclamation.gif" width="12" height="9" alt="New article" /></span>
                </a>
                <a href="?mod=user&act=re_active&u_id=<?php echo $ro['id'];?>" class="button">
        ...
        <div class="module">
             ...
             <div class="module-body">
                <form id="frm_user" name="frm_user" action="index.php?mod=user&act=process_edit&per=<?php echo $permis;?>&c_id=<?php echo $u_id;?>" method="post" enctype="multipart/form-data">
