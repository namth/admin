...
<span id="error"></span> 
    <div class="module">
         ...
         <div class="module-body">
            <form id="add_cat" action="index.php?mod=category&act=process_insert" method="post" name="frm_cat" id="frm_cat" >
                <p>
                ...
                <p>
                    ...
                    <select name="parents" class="input-medium">
                        ...
                        <?php
                            $result = mysql_query("SELECT * FROM tbl_category where lang_id = $lang");
                ...
                <fieldset>
                    <input class="submit-green" type="submit" value="Xác nhận" name="submit" onclick="return check_form()"/> 
